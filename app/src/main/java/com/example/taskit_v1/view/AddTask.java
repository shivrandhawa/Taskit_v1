package com.example.taskit_v1.view;
...
import com.example.taskit_v1.AddTaskPresenter;
import com.example.taskit_v1.Contract;
import com.example.taskit_v1.DatePickerFragment;
import com.example.taskit_v1.GlobalVars;
import com.example.taskit_v1.R;
...
public class AddTask extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, Contract.AddtaskListener, Contract.AddtaskView {
...
//        final TextView tv1 = findViewById(R.id.tv1);
        ...
        post_btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                AddTaskModel model = new AddTaskModel(data);
                presenter.start(model);

                //**model.getTasl_data() will get you the written task
                String testt = model.getTask_data();
                model.addToArray(testt);
                Log.e( "modelo: ,",model.getTask_data());
